...
const SearchItem = props => {
  return(
    <div className="container search-item">
      <div className="row">
        <div className="col-5 col-md-12 col-lg-4 search-item-image">
          <img src={ props.image } alt={ props.name } width="400" />
        </div>
        <div className="col-7 col-md-7 col-lg-5 search-item-details">
          ...
          <div className="search-item-points">
            <p><i className="fas fa-check" /> Fuel Policy: Same-to-same</p>
            <p><i className="fas fa-check" /> Mileage Included: Unlimited</p>
          </div>
        </div>
        <div className="col-md-5 col-lg-3 search-item-pricing">
