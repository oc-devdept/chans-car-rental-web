...
const VehicleSearchMobile = (props) => {
  const [tempDateTime, setTempDateTime] = useState({pickUpDate:"1st Jan 2020", pickUpTime:"10:00", dropOffDate:"3rd Jan 2020", dropOffTime:"10:00"})
  ...
  return(
    <>
      <div className="search-mobile-details">
        ...
        <div className="col-2 d-flex justify-content-center align-items-center" onClick={() => setShowSearchModal(true)}>
      ...
      <div className="search-mobile">
        ...
        > 
          ...
          <Modal.Footer>
            <Button onClick={ () => setShowSearchModal(false) } variant="outline-secondary">
              Close 
            </Button>
          </Modal.Footer>
        </Modal>
