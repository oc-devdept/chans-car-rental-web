    ...
    <Accordion defaultActiveKey="0">
      ...
      <Card>
        <Accordion.Toggle as={Card.Header} eventKey="2">
          Are the published rates same for weekends and throughout the year?
        </Accordion.Toggle>
      ...
      <Card>
        <Accordion.Toggle as={Card.Header} eventKey="3">
          What are your office hours and the minimum hire period?
        </Accordion.Toggle>
      ...
      <Card>
        <Accordion.Toggle as={Card.Header} eventKey="5">
          Can I use your car for re-hire and transportation network services
          like "Uber"?
        </Accordion.Toggle>
