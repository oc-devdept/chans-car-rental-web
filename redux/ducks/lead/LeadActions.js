 ...
 * Follow ups
 */
export const addLeadFollowUp = data => ({
  type: types.ADD_LEAD_FOLLOW_UP,
  payload: data
});
export const editLeadFollowUp = data => ({
  type: types.EDIT_LEAD_FOLLOW_UP,
  payload: data
});
export const deleteLeadFollowUp = id => ({
  type: types.DELETE_LEAD_FOLLOW_UP,
  payload: id
});
